...
| HasTag                   | bool                          | returns true if any string is found in the input string, case insensitive| HasTag(PathTags, "two_HAnd_weAPon")|
| HasTagCase               | bool                          | returns true if any string is found in the input string, case sensitive| HasTag(PathTags, "two_hand_weapon")|
